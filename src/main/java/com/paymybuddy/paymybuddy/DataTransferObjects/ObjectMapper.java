...
public class ObjectMapper {
    ...
    public TransactionDTO toDto(TransactionDAO transactionDAO, UtilisateurDAO utilisateurDAO) {
        ...
        UtilisateurDAO eTransactionEmetteur = new UtilisateurDAO(utilisateurDAO.getIdUtilisateur(), utilisateurDAO.getNom(), utilisateurDAO.getPrenom(), utilisateurDAO.getMotDePasse(), utilisateurDAO.getAdresseEmail(), utilisateurDAO.getDateDeNaissance(), utilisateurDAO.getFondsDisponibles());
        UtilisateurDAO eTransactionDestinataire = new UtilisateurDAO(utilisateurDAO.getIdUtilisateur(), utilisateurDAO.getNom(), utilisateurDAO.getPrenom(), utilisateurDAO.getMotDePasse(), utilisateurDAO.getAdresseEmail(), utilisateurDAO.getDateDeNaissance(), utilisateurDAO.getFondsDisponibles());
