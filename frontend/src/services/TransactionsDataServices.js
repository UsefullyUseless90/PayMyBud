...
class TransactionsDataService {
  ...
  import(idUtilisateur,data){
    return axios.post("http://localhost:8080/paymybuddy/transfert/ajout/" + idUtilisateur, data, {headers: authHeader()} );
  }
  export(idUtilisateur, data){
    return axios.post("http://localhost:8080/paymybuddy/transfert/retrait/" + idUtilisateur, data, {headers: authHeader()} );
  }
